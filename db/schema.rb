...
ActiveRecord::Schema.define(version: 20151206153935) do
  ...
  add_index "relationships", ["own_id", "friend_id"], name: "index_relationships_on_own_id_and_friend_id", unique: true, using: :btree
  add_index "relationships", ["own_id"], name: "index_relationships_on_own_id", using: :btree
